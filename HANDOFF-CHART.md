...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 2100" width="400" role="img" aria-label="MAX-LIT zzzbestmaxlit handoff chart">
  ...
  <text x="32" y="518" class="t">2-7. CONTENT</text>
  <text x="32" y="534" class="r">/page2 through /page7 - marketing and proof</text>
  ...
  <text x="32" y="586" class="t">8. CHATBOX</text>
  <text x="32" y="602" class="r">/maxchatbox8 - MAX-LIT AI chat (1 hr free trial)</text>
  ...
  <text x="32" y="654" class="t">9. TRIAL EXPIRED</text>
  <text x="32" y="670" class="r">/trialexpired9 - free trial ended</text>
  ...
  <text x="32" y="722" class="t">10. CHECKOUT / STRIPE</text>
  ...
  <text x="32" y="790" class="t">11. TIME EXPIRED</text>
  <text x="32" y="806" class="r">/timeexpired11 - cookie gate</text>
  <line x1="200" y1="824" x2="200" y2="840" stroke="#94a3b8" stroke-width="1" marker-end="url(#handoff-arr)"/>

  <rect x="20" y="840" width="360" height="52" rx="6" fill="#f1f5f9" stroke="#94a3b8" stroke-width="1"/>
  <text x="32" y="858" class="t">12. SPARE</text>
  <text x="32" y="874" class="r">/spare12 - reserved placeholder</text>
  <line x1="200" y1="892" x2="200" y2="912" stroke="#94a3b8" stroke-width="1" marker-end="url(#handoff-arr)"/>
  ...
  <text x="32" y="1310" class="r">/maxchatbox8?session_id={CHECKOUT_SESSION_ID}</text>
...
| **Site flow** | `/` → `/page2`–`/page7` → `/maxchatbox8` → `/trialexpired9` → `/checkout10` → `/timeexpired11` → `/spare12` |
