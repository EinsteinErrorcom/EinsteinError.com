...
export default function GeminiKeyForm({ initialOk, initialMessage }: Props) {
  ...
  return (
    <div className="space-y-4 rounded-lg border border-[#D0AB47] p-4 bg-black/20">
      <h2 className="text-lg font-semibold text-[#D0AB47]">Paste a working Gemini key</h2>
      ...
      <input
        ...
        className="w-full rounded bg-[#161b22] border border-[#D0AB47] p-3 text-white"
      />
