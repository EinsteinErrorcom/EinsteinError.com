...
export default async function DevGeminiPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0d1117] text-white p-8 max-w-2xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-[#D0AB47]">Fix Gemini chat — step by step</h1>
      ...
      <div className="space-y-6">
        {STEPS.map((step, index) => (
          <section
            key={step.title}
            className="rounded-lg border border-[#D0AB47]/40 p-5 bg-black/20"
          >
            <h2 className="text-lg font-bold text-[#D0AB47] mb-3">
