  ...
  return (
    <main className="page-wrapper">
      ...
      <div style={{ fontWeight: 'bold', fontStyle: 'italic', color: '#00FFFF', fontSize: '30px' }}>
        ...
        <span style={{ color: '#C5A059' }}><span style={{ fontSize: '30px' }}>E = m ( <span style={{ fontSize: '20px', color: '#FFFFFF' }}>Acceleration</span> <span style={{ fontSize: '25px' }}>x</span> <span style={{ fontSize: '20px', color: '#FFFFFF' }}>Time</span> )<sup>2</sup><br/><span style={{ fontSize: '29px' }}>E =<br/>m ( <span style={{ fontSize: '19px', color: '#FFFFFF' }}>Acc. due to Gravity</span> <span style={{ fontSize: '24px' }}>x</span> <span style={{ fontSize: '19px', color: '#FFFFFF' }}>orbit Time</span> )<sup>2</sup></span><br/><span style={{ fontSize: '29px' }}>E =<br/>m ( <span style={{ fontSize: '20px', color: '#FFFFFF' }}>9.800000045765</span> <span style={{ fontSize: '24px' }}>x</span> <span style={{ fontSize: '20px', color: '#FFFFFF' }}>30591067</span> )<sup>2</sup></span></span><br/><br/>is the absolute<br/>&quot; PURE &quot;<br/>and<br/>CORRECT<br/>Energy&nbsp;&nbsp;Equation&nbsp;&nbsp;!</span><br/><br/><span style={{ color: '#8A2BE2', fontSize: '30px', lineHeight: 1.1 }}>If you argue against this<br/><span style={{ color: '#FFFFFF' }}>&quot;</span> PURE&nbsp;&nbsp;FACT <span style={{ color: '#FFFFFF' }}>&quot;</span><br/>you are only<br/>blowing hot air&nbsp;&nbsp;!</span><br/><br/>
